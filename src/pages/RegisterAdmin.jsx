    ...
    <div className="h-screen flex justify-center items-center flex-row-reverse ">
        ...
        <div className="w-11/12 md:w-6/12  flex justify-center items-center ">
            <div className="h-full w-11/12 flex flex-col justify-center items-center ">
                ...
                <h1 className="w-11/12 text-wrap text-start text-3xl mb-2 font-bold">Create you Account as admin!</h1>
                ...
                <form type="submit" className="w-full flex justify-center flex-col items-center gap-5" onSubmit={handleRegister}>
                    <input type="text" placeholder="Name" className="w-11/12 rounded-md outline-none p-3 bg-white" style={{border:"1px solid gray"}} value={admin.name} 
                    onChange={(e)=>setAdmin({...admin,name: e.target.value})}/>
                    <input type="email" placeholder="Email" className="w-11/12 rounded-md outline-none p-3 bg-white" style={{border:"1px solid gray"}} value={admin.email} 
