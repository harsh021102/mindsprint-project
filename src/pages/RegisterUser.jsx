    ...
    <div className="h-screen flex justify-center items-center flex-row-reverse ">
        ...
        <div className="w-11/12 md:w-6/12  flex justify-center items-center ">
            <div className="h-full w-11/12 flex flex-col justify-center items-center ">
                ...
                <h1 className="w-11/12 text-wrap text-start text-3xl mb-2 font-bold">Create you Account as user!</h1>
                <p className="w-11/12 text-wrap text-start text-sm m-3 font-light">Be part of a 23 million-strong community of developers</p>
                <form type="submit" className="w-full flex justify-center flex-col items-center gap-5" onSubmit={handleRegister}>
                    <input type="text" placeholder="Name" className="w-11/12 rounded-md outline-none p-3 bg-white" style={{border:"1px solid gray"}} value={student.name} 
                    onChange={(e)=>setStudent({...student,name: e.target.value})}/>
                    <input type="email" placeholder="Email" className="w-11/12 rounded-md outline-none p-3 bg-white" style={{border:"1px solid gray"}} value={student.email} 
                    onChange={(e)=>setStudent({...student,email: e.target.value})}/>
                    <input type="password" placeholder="Your password" className="w-11/12 rounded-md outline-none p-3 bg-white" style={{border:"1px solid gray"}} value={student.password} 
