...
const AdminCourseCard = ({title,description}) => {
  const navigate = useNavigate();

  return (
    <div
        className="flex rounded-lg  shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700 w-full">
        <div className="p-6 flex w-full justify-center items-center">
          <div className='flex flex-col md:flex-row justify-between items-center w-full'>
            <div className='flex w-1/2 '>
              <h1 className="mb-2 ml-2 text-xl font-medium leading-tight text-neutral-800 dark:text-neutral-50">Title: </h1>
              <h5 className="mb-2 ml-2 text-xl font-medium leading-tight text-neutral-800 dark:text-neutral-50">
                {title}
              </h5>
            </div>
            <div className='flex w-1/2'>
              <h1 className="mb-2 ml-2 text-xl font-medium leading-tight text-neutral-800 dark:text-neutral-50">Description: </h1>
              <h5 className="mb-2 ml-2 text-xl font-medium leading-tight text-neutral-800 dark:text-neutral-50">
                {description}
              </h5>
            </div>
